...
public class funciones_Auxiliar {
	...
	static int arrancarAplicacion()
	{
		...
		System.out.println("Dejame ayudarte en tu esperiencia, ¿Que te apetece gestionar? ¿Una pelicula? Pulsa 1 o ¿Mejor una serie? pulsa2 ");
		menu=sc.nextInt();
		sc.close();
		...
		}else
		{
			...
			System.out.println("Lo siento,tienes que decirme una pelicula o una serie, es importante para que pueda hacer mi trabajo");
			return -1;
		}
		
		static void gestionarPeliculas(Pelicula [] peliculas) 
		{
			
		System.out.println("¡Estupendo!. Te ubico, estamos en el menu para la gestion de directores de peliculas"+
		"para llevar a cabo cualquier accion primero tenemos que identificar la pelicula en la que quieres realizar las modifiicaciones");
		...
		System.out.println("Bien, pues dime que hago"+
		"Si pulsas 1: Añadimos una director al catalogo de esa pelicula"+"\n"+
		...
		static void gestionarSeries(Series[] series) 
		{
