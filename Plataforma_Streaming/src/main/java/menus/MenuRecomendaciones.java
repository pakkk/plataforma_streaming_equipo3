...
public class MenuRecomendaciones {
	 ...
	 */
	public void showRecomendatios(Audiovisual a) 
	{

		Recommendations recommendations[] = a.getrecommendatios; 
		...
		{
			System.out.println(i + 1 + ".- " + Recommendations[i].getName()+ " " + Recommendations[i].getRecomnedatios());
		}
	...
	public int selectCategories(Audiovisual a)
	{
		...
		{
			option = sc.nextInt();
			if ((option > 0) && (option < a.getRecommendatios().length))
				return option - 1;
			else
				return -1;
		} 
